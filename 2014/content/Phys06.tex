...
\section{}
面間の音速を\(v_\text{inter}\), 面内の音速を\(v_\text{intra}\),
正方格子の逆格子の波数の軸を\(k_1',k_2'\)のように表す。

\(\omega_0\ll \omega_a\)のときの分散関係は、
\begin{equation}\begin{aligned}[b]
    \omega^2 = v_\text{inter}^2k+v_\text{intra}^2 k_1'^2+v_\text{intra}^2 k_2'^2
\end{aligned}\end{equation}
...
分散関係は
\begin{equation}\begin{aligned}[b]
    \omega^2 = v_\text{intra}^2 k_1'^2+v_\text{intra}^2 k_2'^2
\end{aligned}\end{equation}
