...
\subsection{}
前問の結果を\(I\to NI/l\)として、\(-l\leq z\leq l\)で積分すればよい。
\begin{equation}\begin{aligned}[b]
    B_z &= \int_{-l}^l\frac{\mu_0 a^2 NI}{2l(z^2+a^2)^{3/2}}\dd{z}\\
    &=\frac{\mu_0 NI}{l}\int_{0}^{\tan^{-1}(l/a)} \cos\theta \,\dd\theta\\
    \vb*{B}&=\frac{\mu_0 NI}{l}\frac{l}{\sqrt{l^2+a^2}}\vb*{e}_z
\end{aligned}\end{equation}

\subsection{}
\(l\gg a\)のとき、\(l/\sqrt{l^2+a^2}\simeq 1\)である。
